...
public class Study {
    ...
    /* seungho */
    private Integer attendPenalty;

    private Integer homeworkPenalty;
    ...
    public String getStartStudyDateTime(){
        return this.getPublishedDateTime().format(DateTimeFormatter.ofPattern("yyyy년 M월 d일 a h시 m분"));
    }

    public String getClosedStudyDateTime(){
        return this.getClosedDateTime().format(DateTimeFormatter.ofPattern("yyyy년 M월 d일 a h시 m분"));
    }
